/* cand_func_800445D4.c -- one candidate function, decompiled by m2c.
 *
...
void *func_800445D4(void *arg0, void *arg1) {
    s32 sp2C;
    s32 sp30;
    s32 sp34;
    s32 temp_a0;
    ...
    temp_s2 = rcos(M2C_FIELD(arg0, s16 *, 0));
    temp_s3 = rcos(M2C_FIELD(arg0, s16 *, 2));
    temp_v0 = rcos(M2C_FIELD(arg0, s16 *, 4));
    sp34 = temp_v0;
    temp_v0_2 = rsin(M2C_FIELD(arg0, s16 *, 0));
    sp30 = temp_v0_2;
    temp_a2 = -rsin(M2C_FIELD(arg0, s16 *, 2), temp_v0_2);
    sp2C = temp_a2;
    temp_v0_3 = rsin(M2C_FIELD(arg0, s16 *, 4), temp_v0_2, temp_a2, temp_v0);
